const TR_ERROR_MESSAGES: Readonly<Record<string, string>> = {
  ...
  'invitation-already-rejected': 'Bu davet daha önce reddedilmiş.',
  ...
  'notification-not-found': 'Bildirim bulunamadı veya artık geçerli değil.',
  'notification-tenant-mismatch': 'Bu bildirim başka bir çalışma alanına ait.',
  'role-required': 'Bu alana erişmek için kurum yöneticisi olmalısınız.',
  'role-required-institution-admin': 'Öğrenci daveti göndermek için kurum yöneticisi olmalısınız.',
  'student-not-found': 'Bu hesap çalışma alanınızda öğrenci olarak bulunamadı.',
